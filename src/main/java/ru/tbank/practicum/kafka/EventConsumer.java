...
public class EventConsumer {
    ...
    public void consumeTemperatureEvent(String message) {
        metricsService.incrementKafkaConsumed("temperature-events");
